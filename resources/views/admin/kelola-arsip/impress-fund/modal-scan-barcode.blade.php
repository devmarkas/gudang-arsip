        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="row mb-2">
              <div class="col-md-8">
                <div class="input-group">
                  <input type="text" class="form-control mt-1" placeholder="input id arsip" id="scan_archive" onkeyup="scan_barcode()" autofocus>
                </div>
              </div>
              <div class="col-md-2">
            ...
            <div class="table-responsive">
              <table class="table table-sm table-hover tabel-arsip" id="tabel_scan_archive">
                  <thead>
                    <tr>
